  ...
  return (
    <Grid container spacing={5}>
      ...
      <Grid size={{ xs: 12, md: 6 }}>
        ...
        <Typography variant="h4" sx={{ fontWeight: 800, mb: 1.5, lineHeight: 1.15, fontSize: { xs: "1.5rem", md: "2rem" } }}>
          {name}
        </Typography>
        ...
        {stock === 0 ? (
          ...
          <Box>
            ...
            <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
              <Button variant="outlined" color="primary" startIcon={<ArrowBackIcon />} onClick={() => setQuantityAdded(0)}>
                Continue Shopping
              </Button>
              <Button variant="contained" color="primary" component={Link} to="/cart" startIcon={<ShoppingBagOutlinedIcon />}>
                Go to Cart
              </Button>
            </Box>
          </Box>

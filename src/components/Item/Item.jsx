...
const PLACEHOLDER = "https://placehold.co/600x600/1a1a1a/C6A55C?text=No+Image"
  ...
  return (
    <Card sx={{ height: "100%", display: "flex", flexDirection: "column", position: "relative" }}>
      <Box sx={{ position: "relative", overflow: "hidden", height: 240, bgcolor: "#111" }}>
        ...
        />
        {stock <= 3 && stock > 0 && (
          <Chip label={`${stock} left`} size="small" sx={{ position: "absolute", top: 14, right: 14, bgcolor: "rgba(212,175,55,0.15)", color: "#D4AF37", fontWeight: 700, fontSize: "0.6rem", border: "1px solid rgba(212,175,55,0.3)" }} />
        )}
        {stock === 0 && (
          <Chip label="Sold Out" size="small" sx={{ position: "absolute", top: 14, right: 14, bgcolor: "rgba(248,113,113,0.15)", color: "#F87171", fontWeight: 700, fontSize: "0.6rem", border: "1px solid rgba(248,113,113,0.3)" }} />
        )}
      </Box>
      ...
      <CardActions sx={{ px: 2, pb: 2, pt: 1 }}>
        <Button component={Link} to={`/item/${id}`} variant="contained" color="primary" fullWidth>
          View Details
        </Button>
      </CardActions>
    </Card>
